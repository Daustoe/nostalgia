'''
Now I just need to link the button tools to the actual heightmap methods, the only problem
that I can see with this is that we need to set the variables of the methods based on values from
gui sliders. This may present a problem.
...
def writeOut():
    ...
    for each in history:
        if each.name == "change":
            file.write("    hm.changeHeight({})\n".format(each.panel.heightSlider.value - .5))
        elif each.name == "valley":
            file.write("    hm.addvalleys({},{},{},{})\n".format(int(each.panel.numberSlider.value*50), int(each.panel.radiusSlider.value*20), each.panel.radVarSlider.value, each.panel.heightSlider.value))
        elif each.name == "smooth":
            file.write("    hm.smooth({},{},{})\n".format(each.panel.weightSlider.value*20, each.panel.minSlider.value, each.panel.maxSlider.value*5))
        elif each.name == "hill":
            file.write("    hm.addHills({},{},{},{})\n".format(int(each.panel.hillNumSlider.value*50), int(each.panel.radiusSlider.value*20), each.panel.radiusVarSlider.value, each.panel.heightSlider.value))
        elif each.name == "normal":
            file.write("    hm.normalize({},{})\n".format(each.panel.minSlider.value, each.panel.maxSlider.value))
        elif each.name == "rain":
            file.write("    hm.rainErosion({},{},{})\n".format(int(each.panel.rainDropsSlider.value*20000), each.panel.erosionSlider.value, each.panel.sedimentSlider.value))
    file.close()
...
def doneAction():
    if selectedPanel.name == "change":
        ...
        myMap.addValleys(int(selectedPanel.numberSlider.value*50), int(selectedPanel.radiusSlider.value*25), selectedPanel.radVarSlider.value, selectedPanel.heightSlider.value)
    elif selectedPanel.name == "hill":
        myMap.addHills(int(selectedPanel.hillNumSlider.value*50), int(selectedPanel.radiusSlider.value*25), selectedPanel.radiusVarSlider.value, selectedPanel.heightSlider.value)
        ...
        myMap.smooth(int(selectedPanel.weightSlider.value*10), selectedPanel.minSlider.value, selectedPanel.maxSlider.value)
    elif selectedPanel.name == "rain":
        myMap.rainErosion(int(selectedPanel.rainDropsSlider.value*20000), selectedPanel.erosionSlider.value, selectedPanel.sedimentSlider.value)
...
def changeButtonAction():
    ...
    doneButton = button.Button((5, 80), (100, 10), "done", font, myMap.changeHeights, (230, 230, 230), (10, 10, 50))
    ...
    historyPanel.addElement(button.Button((5, historyElementOffset), (220, 10), "change z", font, history[-1].historyAction, (230, 230, 230), (10, 10, 50)))
    historyElementOffset += 15
...
def valleyButtonAction():
    ...
    historyPanel.addElement(button.Button((5, historyElementOffset), (220, 10), "valleys", font, history[-1].historyAction, (230, 230, 230), (10, 10, 50)))
    historyElementOffset += 15
...
def smoothButtonAction():
    ...
    historyPanel.addElement(button.Button((5, historyElementOffset), (220, 10), "smooth", font, history[-1].historyAction, (230, 230, 230), (10, 10, 50)))
    historyElementOffset += 15
...
def normalButtonAction():
    ...
    historyPanel.addElement(button.Button((5, historyElementOffset), (220, 10), "normalize", font, history[-1].historyAction, (230, 230, 230), (10, 10, 50)))
    historyElementOffset += 15
    #myMap.normalize(0, 1)
...
def hillButtonAction():
    ...
    historyPanel.addElement(button.Button((5, historyElementOffset), (220, 10), "hills", font, history[-1].historyAction, (230, 230, 230), (10, 10, 50)))
    historyElementOffset += 15
...
def rainButtonAction():
    ...
    historyPanel.addElement(button.Button((5, historyElementOffset), (220, 10), "rain", font, history[-1].historyAction, (230, 230, 230), (10, 10, 50)))
    historyElementOffset += 15
...
hillButton = button.Button((5, 50), (220, 10), "hills", font, hillButtonAction, (230, 230, 230), (10, 10, 50))
toolPanel.addElement(hillButton)

rainButton = button.Button((5, 65), (220, 10), "rain", font, rainButtonAction, (230, 230, 230), (10, 10, 50))
toolPanel.addElement(rainButton)

valleyButton = button.Button((5, 35), (220, 10), "valleys", font, valleyButtonAction, (230, 230, 230), (10, 10, 50))
toolPanel.addElement(valleyButton)

smoothButton = button.Button((5, 80), (220, 10), "smooth", font, smoothButtonAction, (230, 230, 230), (10, 10, 50))
toolPanel.addElement(smoothButton)

changeButton = button.Button((5, 95), (220, 10), "change z", font, changeButtonAction, (230, 230, 230), (10, 10, 50))
toolPanel.addElement(changeButton)

writeButton = button.Button((5, 110), (220, 10), "write to file", font, writeOut, (230, 230, 230), (10, 10, 50))
toolPanel.addElement(writeButton)

doneButton = button.Button((5, 295), (230, 15), "done", font, doneAction, (230, 230, 230), (10, 10, 50))

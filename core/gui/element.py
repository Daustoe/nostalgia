'''
This is the abstact class that any gui element needs to inherit from. It has the
...
class Element(object):
    ...
    '''
    The render definition takes a surface as an argument and blits its surface
    to the one given.
    '''

...
class LivingObject(gameObject.GameObject):
    '''
    Constructor takes location, sprite surface, and integers of hp, mana,
    defense, and power. Also takes booleans of blocking movement and blocking
    sight.
    '''
    def __init__(self, (x, y), sprite, hp, mana, defense, power, blocks=None,
            blocksSight=None):
